...
//    private static boolean hexString = false;
    ...
    public static void main(String[] args) {
        String s = "wMi9GXULNBv7wW+Yku+wUg==";
        String kk = BinaryConversionUtil.getSixteenBitString();
        String s1 = encryptData_ECB(s, kk);
        System.out.println(s1);
        System.out.println(decryptData_ECB(s,"AhfzbgAzmWLyuGjs"));
    }
...
//            byte[] ivBytes;
//            if (hexString) {
//                keyBytes = BinaryConversionUtil.hexStringToBytes(secretKey);
//                ivBytes = BinaryConversionUtil.hexStringToBytes(iv);
//            } else {
